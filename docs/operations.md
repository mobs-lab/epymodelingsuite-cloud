...
./local/
  bucket/                    # Simulates GCS bucket (created automatically)
    {EXP_ID}/{RUN_ID}/
      inputs/input_*.pkl     # Generated by builder
      results/result_*.pkl   # Generated by runners
...
ls -R ./local/bucket/$EXP_ID/$RUN_ID/inputs/  # Verify: should show input_*.pkl files
...
ls ./local/bucket/$EXP_ID/$RUN_ID/results/  # Verify: should show result_*.pkl files
```
