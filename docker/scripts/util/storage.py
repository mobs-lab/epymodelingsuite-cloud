...
def load_bytes(path: str, decompress: bool = True) -> bytes:
    ...
    decompress : bool, optional
        Whether to gzip-decompress the data after loading (default: True)
...
def save_bytes(path: str, data: bytes, compress: bool = True) -> None:
    ...
    compress : bool, optional
        Whether to gzip-compress the data before saving (default: True)
